...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="container-fluid">
      ...
      <a class="btn btn-primary" href="tambah_kategori-produk.php" role="button">Create Kategori Produk</a>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?=$row['nama']?></td>
                            <td>
    <a class="btn btn-primary" href="view_kategori-produk.php?id=<?=$row['id']?>">View</a>
    <a class="btn btn-primary" href="tambah_kategori-produk.php?idedit=<?=$row['id']?>">Update</a>
    <a class="btn btn-primary" href="delete_kategori-produk.php?iddel=<?=$row['id']?>"
